...
namespace sek
{
	...
	template<typename T0, typename T1, typename T2, typename T3, typename Promoted = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] constexpr bool fcmp_eq(T0 a, T1 b, T2 e_rel, T3 e_abs) noexcept { return fcmp_eq(Promoted{a}, Promoted{b}, Promoted{e_rel}, Promoted{e_abs}); }
	...
	/** @copydoc fcmp_eq
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename Promoted = detail::promote_t<T0, T1, T2>>
	[[nodiscard]] constexpr bool fcmp_eq(T0 a, T1 b, T2 e) noexcept { return fcmp_eq(Promoted{a}, Promoted{b}, Promoted{e}); }
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, typename Promoted = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] constexpr bool fcmp_ne(T0 a, T1 b, T2 e_rel, T3 e_abs) noexcept { return fcmp_ne(Promoted{a}, Promoted{b}, Promoted{e_rel}, Promoted{e_abs}); }
	...
	/** @copydoc fcmp_eq
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_eq(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, const basic_vec<T2, N, A> &e_rel, const basic_vec<T3, N, A> &e_abs) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_eq(prom_vec{a}, prom_vec{b}, prom_vec{e_rel}, prom_vec{e_abs});
	}
	...
	/** @copydoc fcmp_eq
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_eq(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, const basic_vec<T2, N, A> &e) noexcept { return fcmp_eq(a, b, e, e); }
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_ne(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, const basic_vec<T2, N, A> &e_rel, const basic_vec<T3, N, A> &e_abs) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_ne(prom_vec{a}, prom_vec{b}, prom_vec{e_rel}, prom_vec{e_abs});
	}
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_ne(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, const basic_vec<T2, N, A> &e) noexcept { return fcmp_ne(a, b, e, e); }
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_eq(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, T2 e_rel, T3 e_abs) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_eq(prom_vec{a}, prom_vec{b}, static_cast<PromotedT>(e_rel), static_cast<PromotedT>(e_abs));
	}
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_eq(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, T2 e) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_eq(prom_vec{a}, prom_vec{b}, static_cast<PromotedT>(e));
	}
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_ne(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, T2 e_rel, T3 e_abs) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_ne(prom_vec{a}, prom_vec{b}, static_cast<PromotedT>(e_rel), static_cast<PromotedT>(e_abs));
	}
	 ...
	 * @note Arguments are promoted to `double`, or `long double` if one of the arguments is `long double`. */
	template<typename T0, typename T1, typename T2, typename T3, std::size_t N, typename A, typename PromotedT = detail::promote_t<T0, T1, T2, T3>>
	[[nodiscard]] inline vec_mask<PromotedT, N, A> fcmp_ne(const basic_vec<T0, N, A> &a, const basic_vec<T1, N, A> &b, T2 e) noexcept
	{
		using prom_vec = vec<PromotedT, N, A>;
		return fcmp_ne(prom_vec{a}, prom_vec{b}, static_cast<PromotedT>(e));
	}
}